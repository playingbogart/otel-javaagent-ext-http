 ...
 */
package com.wezom.otel.javaagent.http;
...
public class TestAgentHttpResponseCustomizer implements HttpServerResponseCustomizer {
  ...
  public <T> void customize(
    ...
    responseMutator.appendHeader(response, "X-OTEL-TraceId", traceId);
    responseMutator.appendHeader(response, "X-OTEL-SpanId", spanId);
  }
}
